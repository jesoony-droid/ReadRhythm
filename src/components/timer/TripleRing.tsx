...
// 3개 트랙: 바깥→중간→안쪽
const TRACKS = [
  { a: 222, b: 114, color: '#5B7EFF', trackColor: 'rgba(91,126,255,0.2)'  },
  { a: 174, b:  87, color: '#9B6DFF', trackColor: 'rgba(155,109,255,0.2)' },
  { a: 126, b:  60, color: '#30D158', trackColor: 'rgba(48,209,88,0.2)'   },
] as const;
